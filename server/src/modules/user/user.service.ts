...
import { EXCEPTION_USER_EMAIL_REGISTERED, EXCEPTION_USER_NOT_FOUND, EXCEPTION_USER_PASSWORD_ERROR } from 'src/constant/exception/user';
...
export class UserService {
    ...
    async createUser(createUserDto: CreateUserDto) {
        ...
        const hasRegistered = await this.userRepo.findOne({
            where: {
                email,
            },
        });
        ...
        if (hasRegistered) {
            throw new BadRequestException(EXCEPTION_USER_EMAIL_REGISTERED);
        }
